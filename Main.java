...
public class Main
{
	...
	class SJF extends Thread
	{
		...
		public void run()
		{
			startTime = System.currentTimeMillis(); //Time of Arrival; will be different for each thread, since they come at different times.
			while(globalBoolean)
			{
...
//			System.out.println(this.getName() + " is Closing");
	 ...
	 * So, queue1 should run for some time slice, lets say 100ms.
	 * After 100ms, it should switch to another thread by removing queue1 from the array, and then adding it to the back.
